                    ...
                    <fieldset>
                        ...
                        <div className="input-block">
                            ...
                            <div className="button-select">
                                <button type="button" className={opening_on_weekends ? 'active' : ''} onClick={() => setOpeningOnWeekends(true)}>Sim</button>
                                <button type="button" className={!opening_on_weekends ? 'active' : ''} onClick={() => setOpeningOnWeekends(false)}>Não</button>
                            </div>
                        </div>
                    </fieldset>
